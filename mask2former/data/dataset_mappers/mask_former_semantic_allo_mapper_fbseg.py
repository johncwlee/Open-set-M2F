...
__all__ = ["MaskFormerALLOFBSegSemanticDatasetMapper"]


class MaskFormerALLOFBSegSemanticDatasetMapper:
    """
    """
    ...
    def __call__(self, dataset_dict):
        ...
        assert not torch.isin(sem_seg_gt.unique(), 8).any().item(), \
            f"ERROR: Anomaly class found during training {dataset_dict['file_name']}..."
